  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
        	<div class="title">
            	<h4>配件使用资料</h4>
                <p>包括配件使用的基本信息及系统使用功能设定</p>
            </div>
            <div class="content">
          <ui:FormField label="配件ID" name="bean.partId"  required="true" maxlength="11" mode="edit"/>
          <ui:FormField label="工单ID" name="bean.workOrderId"  required="false" maxlength="11" mode="edit"/>
