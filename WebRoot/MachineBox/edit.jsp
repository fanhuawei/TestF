  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="系列号" name="bean.serialNo"  required="true" maxlength="150" mode="edit"/>
          <ui:FormField label="控制器型号" name="bean.controllModel"  required="false" maxlength="150" mode="edit"/>
          <ui:FormField label="有效标记" name="bean.validFlag"  required="true" maxlength="3" mode="edit"/>
