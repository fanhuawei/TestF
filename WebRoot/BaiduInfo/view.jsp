  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="用户ID" name="bean.userId" mode="view" />
          <ui:FormField label="设备序列号" name="bean.deviceSn" mode="view" />
          <ui:FormField label="客户端ID" name="bean.clientId" mode="view" />
          <ui:FormField label="通道ID" name="bean.channelId" mode="view" />
          <ui:FormField label="应用ID" name="bean.appId" mode="view" />
          <ui:FormField label="设备类型 A:android I :ios" name="bean.deviceType" mode="view" />
