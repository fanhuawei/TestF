    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <dl class="form_edit">
          ...
          <ui:FormField label="简称拼音" name="filter.pingYing" mode="filter" />
          <ui:FormField label="等级" name="filter.grade" mode="filter" />
          ...
          <ui:FormField label="责任销售" name="filter.saleManager" mode="filter" />
          ...
          <ui:FormField label="售后联系人" name="filter.customerService" mode="filter" />
          <ui:FormField label="售后联系人电话" name="filter.customerServiceMobile" mode="filter" />
          <ui:FormField label="售后联系邮箱" name="filter.customerServiceEmail" mode="filter" />
