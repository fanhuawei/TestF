  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="代班人ID" name="bean.coverUserId" mode="view" />
          <ui:FormField label="开始时间" format="yyyy-MM-dd" name="bean.startTime" mode="view" />
          <ui:FormField label="结束时间" format="yyyy-MM-dd" name="bean.endTime" mode="view" />
