    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <dl class="form_edit">
          ...
          <ui:FormField label="规格" name="filter.spec" mode="filter" />
          <ui:FormField label="货币" name="filter.currency" mode="filter" />
          <ui:FormField label="价格" name="filter.price" mode="filter" />
          <ui:FormField label="单位" name="filter.unit" mode="filter" />
          <ui:FormField label="分组" name="filter.grp" mode="filter" />
          <ui:FormField label="数量" name="filter.amount" mode="filter" />
            <div class="clear"></div>
        </dl>
      </div>
