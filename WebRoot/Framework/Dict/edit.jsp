  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
        	<div class="title">
            	<h4>数据字典</h4>
                <p>包括数据的基本信息及系统使用功能设定</p>
            </div>
            <div class="content">
            	<div class="col col_half">
                	<label class="name" for="code">数据编码<span class="must">*</span></label>
                	<input type="text" maxlength="50"  name="bean.code" id="code" class="common_input" value="${bean.code}" placeholder="请输入数据编码…" />
                </div>
                <div class="col col_half">
                	<label class="name" for="name">数据名称<span class="must">*</span></label>
                    <input type="text" maxlength="30"  name="bean.name" id="name" class="common_input" value="${bean.name}" placeholder="请输入数据名称…" />
                </div>
                <div class="clear"></div>
             </div>
