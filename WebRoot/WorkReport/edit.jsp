  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="报告人员" name="bean.reportorId"  required="true" maxlength="11" mode="edit"/>
          <ui:FormField label="类型 D: 开机报告，S：服务报告" name="bean.type"  required="true" maxlength="3" mode="edit"/>
          <ui:FormField label="内容" name="bean.content"  required="true" maxlength="9000" mode="edit"/>
          <ui:FormField label="路途工时" name="bean.journeyHour"  required="false" maxlength="11" mode="edit"/>
          <ui:FormField label="现场工时" name="bean.liveHour"  required="false" maxlength="11" mode="edit"/>
