  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="标题" name="bean.title" mode="view" />
          <ui:FormField label="内容" name="bean.content" mode="view" />
          <ui:FormField label="接受人数量" name="bean.cnt" mode="view" />
          <ui:FormField label="设备ID" name="bean.deviceId" mode="view" />
          <ui:FormField label="状态：N:未发送 F:发送失败 S：发送成功" name="bean.status" mode="view" />
