  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
        	<div class="title">
            	<h4>工单流附件资料</h4>
                <p>包括工单流附件的基本信息及系统使用功能设定</p>
            </div>
            <div class="content">
          <ui:FormField label="工单流ID" name="bean.workFlowId"  required="false" maxlength="11" mode="edit"/>
          <ui:FormField label="用户ID" name="bean.userId"  required="false" maxlength="11" mode="edit"/>
          <ui:FormField label="附件ID" name="bean.attachmentId"  required="false" maxlength="11" mode="edit"/>
