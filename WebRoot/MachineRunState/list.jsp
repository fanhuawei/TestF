    ...
    <div class="table_main">
      ...
      <tbody>
        <tr class="m_table_title">
          ...
          <th width="100px">采集设备</th>
          <th width="100px">工单ID</th>
          <th width="100px">采集时间</th>
          <th width="100px">数据状态 A：正常 B：警告 C：停机</th>
          <th width="100px">运行状态 A：正常  C：停机</th>
          <th width="100px">采集内容</th>
          <th width="100px">文字内容</th>
        ...
        <tr>
          ...
          <td><fmt:formatDate value="${item.collectTime}" pattern="yyyy-MM-dd"/></td>
