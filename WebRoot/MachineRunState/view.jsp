  ...
  <div class="model_iTable">
    ...
    <div class="form_main">
    	<div class="form_section">
          ...
          <ui:FormField label="采集设备" name="bean.boxId" mode="view" />
          <ui:FormField label="工单ID" name="bean.workOrderId" mode="view" />
          <ui:FormField label="采集时间" format="yyyy-MM-dd" name="bean.collectTime" mode="view" />
          <ui:FormField label="数据状态 A：正常 B：警告 C：停机" name="bean.dataStatus" mode="view" />
          <ui:FormField label="运行状态 A：正常  C：停机" name="bean.runStatus" mode="view" />
          <ui:FormField label="采集内容" name="bean.content" mode="view" />
          <ui:FormField label="文字内容" name="bean.wordContent" mode="view" />
